...
st.markdown("""
    ...
    /* Style des cadres pour les titres uniquement */
    .cadre-titre {
        ...
        margin-bottom: 10px;
        text-align: center;
        background-color: #F0F7FF; /* Un léger fond bleu pour faire ressortir le titre */
    }
...
st.markdown(f'<div class="chiffre-bleu">{investi:.2f} €</div>', unsafe_allow_html=True)
